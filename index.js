...
let displayStr = `A total of $${totalContributions} has been raised for ${totalGames - unfundedGamesCount} games. 
Currently ${unfundedGamesCount} ${unfundedGamesCount === 1 ? 'game remains' : 'games remain'} unfunded. We
